...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //2.和之前保存的app版本号 对比 如果相同，则从主页启动，如果不同从欢迎页启动
    NSString *oldVersion=[[NSUserDefaults standardUserDefaults]objectForKey:@"CFBundleVersion"];
    if (oldVersion == nil) {
        //从欢迎页启动
        
        UIStoryboard* storyboard=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
        KGWelcomeViewController* welVC =[storyboard instantiateViewControllerWithIdentifier:@"welcomePage"];
